...
from requetes import get_zone_20km,get_commune,get_longest_line,get_epsgcode_by_dept,get_common_part
...
if (epsg1) and (epsg1 == epsg2):
    geojson1 = get_zone_20km(lat1,lon1,epsg1)
    # with open('debug1.geojson','w') as g:
    #     g.write(geojson1)
    geojson2 = get_zone_20km(lat2,lon2,epsg2)
